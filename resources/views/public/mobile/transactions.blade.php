...
<script>
const mobileTransactionAnalyticsScript = document.currentScript

document.addEventListener('DOMContentLoaded', () => {
    const root = mobileTransactionAnalyticsScript?.previousElementSibling?.querySelector('[data-transaction-analytics-app]')
