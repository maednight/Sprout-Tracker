...
<head>
  ...
  <title>Transactions | Sprout Income Expense Tracker</title>
  ...
  @vite(['resources/css/app.css', 'resources/css/transactions/transactions.css', 'resources/js/app.js'])
</head>
<body class="sprout-font">
  <div class="sprout-appshell">
    <div class="sprout-view sprout-view--mobile">
      @include('public.transactions.mobile.transactions')
    </div>

    <div class="sprout-view sprout-view--desktop">
      @include('public.transactions.desktop.transactions')
    </div>
  </div>
</body>
</html>
